...
class AppTheme {
  ...
  static const TextStyle _lightHeadingMediumText = TextStyle(
    color: _lightTextColorPrimary,
    fontFamily: "Rubik",
    fontSize: 22,
  ...
  static const TextTheme _lightTextTheme = TextTheme(
    ...
    titleMedium: _lightHeadingMediumText,
  ...
  static final TextStyle _darkThemeHeadingMediumTextStyle =
      _lightHeadingMediumText.copyWith(color: _darkTextColorPrimary);
  ...
  static final TextTheme _darkTextTheme = TextTheme(
    ...
    titleMedium: _darkThemeHeadingMediumTextStyle,
